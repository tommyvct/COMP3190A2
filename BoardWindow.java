    ...
    private class BoardPanel extends JPanel{
        ...
        private void drawTile(Graphics2D g2d, Tile currentTile, int row, int col){
            ...
            if(currentTile.hasAgent()){
                ...
                Agent agent = currentTile.getAgent();
                //System.out.println("Agent art detected" + agent.toString() + currentTile.toString());
                BufferedImage foregroundImage = ImageLoader.loadImage(agent.getImageName());
                g2d.drawImage(foregroundImage, xOffset, yOffset, tileSize, tileSize, null);
            }

            if(currentTile.hasThing()){
                
                Thing thing = currentTile.getThing();
                //System.out.println("Agent art detected" + agent.toString() + currentTile.toString());
                BufferedImage foregroundImage = ImageLoader.loadImage(thing.getImageName());
                g2d.drawImage(foregroundImage, xOffset, yOffset, tileSize, tileSize, null);
            }
        }
